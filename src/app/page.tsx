      ...
      <div className="w-full md:w-1/2 flex flex-col">
        ...
        <main className="flex-grow flex flex-col items-center justify-center p-8 md:p-12 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-lg mb-12">
            The No Follow-Up Required (NFR) framework reclaims the time and money you waste managing other people's commitments. It is a strict Promise Fulfillment Agent for executives.
          </p>
