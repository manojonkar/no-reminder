      ...
      <header className="p-6 flex justify-between items-center max-w-6xl w-full mx-auto">
        ...
        <nav className="text-sm font-medium" aria-label="Main Navigation">
          <button 
            ...
            className="px-6 py-2 bg-[#D4AF37] text-[#0A192F] font-bold rounded hover:opacity-90 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-midnight-navy dark:focus-visible:outline-white"
          >
            Log In to Portal
          </button>
        </nav>
